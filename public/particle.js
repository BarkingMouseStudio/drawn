(function() {
  ...
  D.Constants.drag = 0.00015;

  D.Constants.gravity = new THREE.Vector3(0, -9.8, 0);
  ...
  D.Particle3D = Particle3D = (function(_super) {
    ...
    Particle3D.prototype.update = function() {
      ...
      this.acceleration.addSelf(D.Constants.gravity);
      this.acceleration.multiplyScalar(this.mass);
      this.acceleration.multiplyScalar(0);
      this.velocity.addSelf(this.acceleration);
      this.velocity.multiplyScalar(D.Constants.drag);
